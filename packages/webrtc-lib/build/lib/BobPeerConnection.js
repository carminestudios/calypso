...
var BobPeerConnection =
/*#__PURE__*/
function () {
  function BobPeerConnection(config, connectionOffer) {
    var _this = this;

    (0, _classCallCheck2["default"])(this, BobPeerConnection);
    var rtcPeerConnectionConfig = {
      'iceServers': config && config.iceServers ? config.iceServers : _utils.iceServers
    };
    this.config = config;
  ...
  (0, _createClass2["default"])(BobPeerConnection, [{
...
var _default = BobPeerConnection;
