...
var _SignalingHandler = require("./SignalingHandler");
...
function () {
  function BobRTC(masterServerURL, signalingHandler) {
    ...
    (0, _classCallCheck2["default"])(this, BobRTC);
    ...
    this.signalingHandler = signalingHandler ? signalingHandler : new _SignalingHandler.SignalingHandler(masterServerURL);
    ...
    this._signalingMethods = {
      ...
      'peers': function peers(_peers) {
        ...
        for (var i = 0; i < filteredPeers.length; i++) {
          ...
          var signalPeer = new _Peer["default"](config, _this);
      ...
      'peer:offer': function peerOffer(peerId, offer) {
        ...
        var signalPeer = new _Peer["default"](config, _this, remoteDescription);
  ...
  (0, _createClass2["default"])(BobRTC, [{
    key: "connect",
